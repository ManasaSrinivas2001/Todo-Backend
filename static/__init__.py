...
def create_app(test_config=None):
    app = Flask(__name__)
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://shacjlonykcrdup:20b6d18de2ac3795f3a20a1fde8fd01a585923c3b33d316f06434d54df3e2b2e@ec2-34-236-94-53.compute-1.amazonaws.com:5432/d4qln4qh957ufr'
